...
├── sim/
│   ├── tb_matmul_vlog.prj    # xvlog project file (Vivado CLI simulation)
│   └── tb_matmul.tcl         # xsim run script (log_wave + run all)
├── vivado_proj/
│   └── matmul_9x9.xpr        # Vivado GUI project (generated by setup_project.tcl)
